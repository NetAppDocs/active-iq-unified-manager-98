...
. link:task-configuring-event-notification-settings.html[Configure event notification settings]
+
...
. link:task-enabling-remote-authentication.html[Enable remote authentication]
+
...
. link:task-adding-users.html[Add users]
+
...
. link:task-adding-alerts.html[Add alerts]
+
