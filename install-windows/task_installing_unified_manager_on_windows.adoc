...
You can access the web UI to perform the initial setup of Unified Manager, as described in the http://docs.netapp.com/ocum-98/topic/com.netapp.doc.onc-um-sysconfig/home.html[Active IQ Unified Manager System Configuration Guide].
