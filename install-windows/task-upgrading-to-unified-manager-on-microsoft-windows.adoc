...
sidebar: sidebar
keywords: 
summary: 'You can upgrade Unified Manager 9.6 or 9.7 to 9.8 by downloading and running the installation file on the Windows platform.'
---
...
[.lead]
You can upgrade Unified Manager 9.6 or 9.7 to 9.8 by downloading and running the installation file on the Windows platform.
