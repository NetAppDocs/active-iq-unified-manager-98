...
Access the web UI to change the default password of the umadmin user, and perform the initial setup of Unified Manager, as described in the xref:concept-configuring-unified-manager.adoc[Configuring Active IQ Unified Manager].
