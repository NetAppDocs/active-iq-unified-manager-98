...
For information about Unified Manager REST APIs, see link:..api-automation/concept-getting-strated-with-getting-started-with-um-apis.html[Getting started with Active IQ Unified Manager].
