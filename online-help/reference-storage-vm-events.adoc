...
sidebar: sidebar
keywords: 
summary: 'Storage VM events provide you with information about the status of your SVMs so that you can monitor for potential problems. Events are grouped by impact area and include the event and trap name, impact level, source type, and severity.'
---
= Storage VM events
:icons: font
:imagesdir: ../media/
...
[.lead]
Storage VM events provide you with information about the status of your SVMs so that you can monitor for potential problems. Events are grouped by impact area and include the event and trap name, impact level, source type, and severity.
