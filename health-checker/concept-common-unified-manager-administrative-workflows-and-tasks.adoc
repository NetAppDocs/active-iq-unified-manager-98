...
* Using REST APIs to help manage your clusters by viewing the health, capacity, and performance information captured by Unified Manager. See the See link:../api-automation/concept-getting-strated-with-getting-started-with-um-apis.html[Getting started with Active IQ Unified Manager REST APIs] for more information.
